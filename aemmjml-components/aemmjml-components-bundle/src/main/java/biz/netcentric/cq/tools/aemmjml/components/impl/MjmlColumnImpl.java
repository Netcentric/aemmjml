...
@Model(
        ...
        adapters = { MjmlColumnImpl.class, MjmlContainer.class, MjmlComponent.class },
        resourceType = "netcentric/aemmjml/core/components/column"
)
public class MjmlColumnImpl implements MjmlContainer {
    ...
    @Inject
    public MjmlColumnImpl(@Self Resource self) {
