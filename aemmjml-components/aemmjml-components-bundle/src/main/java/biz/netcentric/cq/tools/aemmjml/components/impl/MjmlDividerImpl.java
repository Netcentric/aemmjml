...
@Model(
        ...
        adapters = {MjmlDividerImpl.class, MjmlComponent.class},
        resourceType = "netcentric/aemmjml/core/components/divider"
)
public class MjmlDividerImpl implements MjmlComponent {

    private final Map<String, String> attributes;

    @Inject
    public MjmlDividerImpl(@Self Resource self) {
