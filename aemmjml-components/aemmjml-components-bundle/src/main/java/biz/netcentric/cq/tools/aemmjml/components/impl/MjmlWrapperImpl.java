...
@Model(
        ...
        adapters = { MjmlWrapperImpl.class, MjmlContainer.class, MjmlComponent.class },
        resourceType = "netcentric/aemmjml/core/components/wrapper"
)
public class MjmlWrapperImpl implements MjmlContainer {

    private final Map<String, String> attributes;

    @Inject
    public MjmlWrapperImpl(@Self Resource self) {
